 ...
 * @param {boolean} [options.includeMinutesOnTheHour] - Whether to include :00 minutes on the hour (default: false)
...
export function formatTime(input, options) {
  try {
    ...
    const formatter =
      time.minute === 0 && !resolvedOptions.includeMinutesOnTheHour ? hourFormat : timeFormat
