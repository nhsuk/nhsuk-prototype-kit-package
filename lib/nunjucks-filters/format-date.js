 ...
 *
 * @param {Partial<DateInputObject>} input - Object to check for year, month and day
...
/**
 * @param {string|DateInputObject|unknown} input - Date as ISO string or object with year, month, day (and optionally hour, minute, offset)
