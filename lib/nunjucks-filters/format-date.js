...
/**
 * @param {DateInput | string | unknown} input - Date as ISO string or object with year, month, day (and optionally hour, minute, offset)
 ...
 * @param {DateInput | string | unknown} input - Date as ISO YYYY-MM-DD string or object with day, month, year (and optionally hour, minute, offset)
