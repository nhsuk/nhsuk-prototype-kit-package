...
describe('formatTime', () => {
  ...
  it('displays midday instead of 12:00pm', () => {
    ...
    assert.equal(formatTime('12:00', { includeMinutesOnTheHour: true }), 'midday')
  })

  it('displays midnight instead of 00:00', () => {
    assert.equal(formatTime('00:00'), 'midnight')
    assert.equal(formatTime('00:00', { includeMinutesOnTheHour: true }), 'midnight')
  })
  ...
  it('displays 12:00pm instead of midday if middayMidnight: false and includeMinutesOnTheHour: true', () => {
    assert.equal(
      formatTime('12:00', { middayMidnight: false, includeMinutesOnTheHour: true }),
      '12:00pm'
    )
  })
  ...
  it('displays 12:00am instead of midnight if middayMidnight: false and includeMinutesOnTheHour: true', () => {
    assert.equal(
      formatTime('00:00', { middayMidnight: false, includeMinutesOnTheHour: true }),
      '12:00am'
    )
  })
  ...
  it('keeps the minutes for times on the hour if includeMinutesOnTheHour: true', () => {
    assert.equal(formatTime('14:00', { includeMinutesOnTheHour: true }), '2:00pm')
    assert.equal(
      formatTime({ hour: '14', minute: '0' }, { includeMinutesOnTheHour: true }),
      '2:00pm'
    )
  })
