...
describe('formatDate', () => {
  ...
  it('displays an error if the ISO date string contains timezone info', () => {
    assert.equal(formatDate('2026-01-01T02:35Z'), 'Invalid date')
    assert.equal(formatDate('2026-01-01T02:35+01:00'), 'Invalid date')
    assert.equal(
      formatDate('2026-01-01T02:35+01:00[Europe/London]'),
      'Invalid date'
    )
  })
})
