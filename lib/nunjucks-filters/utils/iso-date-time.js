 ...
 *
 * @template {string} InputType
 * @param {InputType | unknown} input - String to test
 * @returns {input is InputType} `true` if the string matches
 */
export function isIsoDateTimeWithoutOffset(input) {
  return typeof input === 'string'
    ? isoDateTimeNoOffsetFormat.test(input)
    : false
}
...
export function isIsoDateTimeWithOffset(input) {
  return typeof input === 'string'
    ? isoDateTimeWithOffsetFormat.test(input)
    : false
}
 ...
 *
 * @param {string | unknown} input - String to test
 * @returns {input is string} `true` if the string matches
 */
export function hasIsoOffset(input) {
  return typeof input === 'string' ? isoTimeWithOffsetFormat.test(input) : false
}
