 ...
 *
 * @param {Partial<DateTimeInputObject>} input - Object to check for year, month, day, hour, minute and offset
 ...
 *
 * @typedef {DateInputObject & TimeInputObject & { offset: string }} DateTimeInputObject
 */
