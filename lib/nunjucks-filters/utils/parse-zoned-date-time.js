 ...
 *
 * @param {Partial<DateTimeInput>} input - Object to check for year, month, day, hour, minute and offset
...
/**
 * A full date and time with a timezone offset, e.g. from combined Date and
 * Time input components. `offset` is only meaningful with a full date and time.
 *
 * @typedef {DateInput & TimeInput & { offset: string }} DateTimeInput
 */

/**
 * @import { DateInput } from '../format-date.js'
 * @import { TimeInput } from '../format-time.js'
 */
