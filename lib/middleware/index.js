...
export function configureLocals(options) {
  ...
  app.use((req, res, next) => {
    ...
    res.locals.nhsappFrontendVersion = config.nhsappFrontendVersion
...
export function configure(options) {
  ...
  // Add body-parser for parsing data sent in forms
  // Size and parameter limits have been increased from the
  // defaults to enable longer forms if needed.
  app.use(
