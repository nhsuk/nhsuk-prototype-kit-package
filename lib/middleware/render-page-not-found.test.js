...
describe('renderPageNotFound', () => {
  ...
  it('passes the request path to the template', () => {
    let capturedView, capturedData
    ...
    assert.strictEqual(capturedView, '404')
    assert.deepStrictEqual(capturedData, { path: '/test-path' })
  })
})
