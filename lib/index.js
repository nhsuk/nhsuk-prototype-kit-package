...
NHSPrototypeKit.init = function (app, nunjucksEnv) {
  ...
  nunjucksEnv.loaders[0].searchPaths.push(prototypeKitViewsPath)

  // Turn off Nunjucks caching
  nunjucksEnv.opts.noCache = true

  // Enables autoescaping (enabled by default)
  nunjucksEnv.opts.autoescape = true

  // Turn off watching for template changes (false by default)
  nunjucksEnv.opts.watch = false
