...
/**
 * @param {NHSPrototypeKitOptions} options
 */
...
NHSPrototypeKit.init = function (options) {
  ...
  options.express.use(NHSPrototypeKit.middleware.all(options))
...
/**
 * @typedef {object} NHSPrototypeKitOptions
 * @property {string} [serviceName] - Service name
 * @property {Express} express - Express app
