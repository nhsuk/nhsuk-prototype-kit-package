...
NHSPrototypeKit.init = function (options) {
  ...
  if (options.appViews) {
    nunjucksViews.push(options.appViews)
  }
  ...
  nunjucksViews.push(join(nhsukFrontendPath, 'dist/nhsuk/components'))
  nunjucksViews.push(join(nhsukFrontendPath, 'dist/nhsuk/macros'))
  nunjucksViews.push(join(nhsukFrontendPath, 'dist/nhsuk'))
  nunjucksViews.push(join(nhsukFrontendPath, 'dist'))
