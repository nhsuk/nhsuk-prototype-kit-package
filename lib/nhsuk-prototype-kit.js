...
NHSPrototypeKit.init = function (options) {
  ...
  options.nunjucks.loaders[0].searchPaths.push(join(nhsukFrontendPath, 'dist/nhsuk/components'))
  options.nunjucks.loaders[0].searchPaths.push(join(nhsukFrontendPath, 'dist/nhsuk/macros'))
  options.nunjucks.loaders[0].searchPaths.push(join(nhsukFrontendPath, 'dist/nhsuk'))
  options.nunjucks.loaders[0].searchPaths.push(join(nhsukFrontendPath, 'dist'))
